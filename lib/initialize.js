...
var connectSailsClient = require('./connect-sails-client');
  ...
  return function initialize (done) {
    ...
    (function waitForOtherHooks(next){
      ...
      prepareAdapter(function (err){
        ...
        // Create a new socket for this Sails instance that will listen for administrative events
        // that need to be distributed across all nodes in a clustered environment
        // connectSailsClient(app);
